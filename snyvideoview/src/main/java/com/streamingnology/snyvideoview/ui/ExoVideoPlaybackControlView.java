package com.streamingnology.snyvideoview.ui;
...
import com.streamingnology.snyvideoview.R;
import com.streamingnology.snyvideoview.extension.MultiQualitySelectorAdapter;
import com.streamingnology.snyvideoview.gesture.OnVideoGestureChangeListener;
import com.streamingnology.snyvideoview.gesture.VideoGesture;
import com.streamingnology.snyvideoview.media.ExoMediaSource;
import com.streamingnology.snyvideoview.orientation.OnOrientationChangedListener;
import com.streamingnology.snyvideoview.orientation.SensorOrientation;
...
import static com.streamingnology.snyvideoview.orientation.OnOrientationChangedListener.SENSOR_UNKNOWN;
    ...
    private void showControllerByDisplayMode() {
        ...
        if (exoPlayerControllerBottom != null) {
            ...
            if (portrait) {
                ...
                ImageButton ib = exoPlayerControllerBottom.findViewById(R.id.exo_player_exit_fullscreen);
                if (ib != null) {
                    ib.setVisibility(INVISIBLE);
                }
                ib = exoPlayerControllerBottom.findViewById(R.id.exo_player_enter_fullscreen);
                if (ib != null) {
                    ib.setVisibility(VISIBLE);
                }
            } else {
                ImageButton ib = exoPlayerControllerBottom.findViewById(R.id.exo_player_enter_fullscreen);
                if (ib != null) {
                  ib.setVisibility(INVISIBLE);
                }
                ib = exoPlayerControllerBottom.findViewById(R.id.exo_player_exit_fullscreen);
                if (ib != null) {
                  ib.setVisibility(VISIBLE);
                }
            }
